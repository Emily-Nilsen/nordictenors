  ...
  return (
    <>
      <Head>
        <meta
          property="og:title"
          content="Christmas with Nordic Tenors 2024 - Sandnes og Stavanger"
        />
        <meta
          property="og:description"
          content="Sandnes Kulturhus - lørdag 14. des / Stavanger Konserthus - søndag 15. des."
        />
        <meta
          property="og:image"
          content="/images/Christmas_with_Nordic_Tenors.webp"
        />
        <meta
          property="og:url"
          content="https://nordictenors.no/sandnes-stavanger"
        />
