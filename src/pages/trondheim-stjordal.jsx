...
const posts = [
  {
    id: 2,
    title: 'Olavshallen, Trondheim',
    imageUrl: '/halls/Olavshallen.webp',
    date: 'onsdag 18. des kl. 18:00',
    datetime: '2024-12-18',
    category: {
      title: 'Billetter',
      href: 'https://www.olavshallen.no/forestillinger/2023-11-23-christmas-with-nordic-tenors?utm_source=Social&utm_medium=Social&utm_campaign=Nordictenors&utm_id=Nordictenors',
    },
    pageUrl: '/konserter/trondheim-julekonsert',
  },
  {
    id: 1,
    title: 'Kimen Kulturhus, Stjørdal',
    imageUrl: '/halls/Kimen_kulturhus.webp',
    date: 'lørdag 21. des kl. 18:00',
    datetime: '2024-12-21',
    category: {
      title: 'Billetter',
      href: 'https://tix.no/nb/kimenkulturhus/buyingflow/tickets/27102/50673/',
    },
    pageUrl: '/konserter/stjordal-julekonsert',
  },
]

export default function TrondheimStjordal() {
  return (
