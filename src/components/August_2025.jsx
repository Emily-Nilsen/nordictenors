...
const concerts = [
  {
    id: 1,
    name: 'Knarvik Kyrkje, Knarvik',
    imageUrl: '/thumbnails/knarvik_kyrkje.webp',
    date: '29. august',
    isoDate: '2025-08-29T19:00:00.000Z',
    ticketLink: 'https://nordhordland.easyticket.no/',
    pageUrl: '/konserter/knarvik-a-la-carte-2025',
  },
]

export function August_2025() {
  ...
  return (
    <div id="august" className="w-full overflow-x-hidden rounded-xl ">
