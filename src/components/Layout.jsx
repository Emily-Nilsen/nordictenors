...
export const navigation = [
  ...
  // julekonsert
  {
    ...
    links: [
      { title: 'Arendal', href: '/konserter/arendal-julekonsert' },
      { title: 'Asker', href: '/konserter/asker-julekonsert' },
      { title: 'Askim', href: '/konserter/askim-julekonsert' },
      { title: 'Bergen', href: '/konserter/bergen-julekonsert' },

      { title: 'Bodø', href: '/konserter/bodo-julekonsert' },
      {
        title: 'Drammen',
        href: '/konserter/drammen-julekonsert',
      },
      { title: 'Flekkefjord', href: '/konserter/flekkefjord-julekonsert' },
      { title: 'Fredrikstad', href: '/konserter/fredrikstad-julekonsert' },
      ...
      { title: 'Sandvika', href: '/konserter/sandvika-julekonsert' },

      { title: 'Stavanger', href: '/konserter/stavanger-julekonsert' },
  ...
  // À la carte 2025
  {
    ...
    links: [
      { title: 'Bergen', href: '/konserter/bergen-a-la-carte' },
      { title: 'Drammen', href: '/konserter/drammen-a-la-carte' },
      { title: 'Fredrikstad', href: '/konserter/fredrikstad-a-la-carte' },
      { title: 'Grong', href: '/konserter/grong-a-la-carte' },
      { title: 'Haugesund', href: '/konserter/haugesund-a-la-carte' },
  ...
  // Christmas with Nordic Tenors 2025
  {
    ...
    links: [
      { title: 'Arendal', href: '/konserter/arendal-julekonsert-2025' },
      ...
      { title: 'Hønefoss', href: '/konserter/honefoss-julekonsert-2025' },
      {
        title: 'Lillehammer',
