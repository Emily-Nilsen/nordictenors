...
export const navigation = [
  ...
  // Christmas with Nordic Tenors 2026
  {
    ...
    links: [
      ...
      {
        title: 'Bergen',
        href: '/konserter/bergen-julekonsert-2026',
      ...
      {
        title: 'Larvik',
        href: '/konserter/larvik-julekonsert-2026',
      ...
      {
        title: 'Lørenskog',
        href: 'konserter/lorenskog-julekonsert-2026',
      ...
      {
        title: 'Oslo',
        href: '/konserter/oslo-julekonsert-2026',
      ...
      {
        title: 'Sandvika',
        href: '/konserter/sandvika-julekonsert-2026',
      ...
      {
        title: 'Ålesund',
        href: '/konserter/alesund-julekonsert-2026',
