  ...
  return (
    <Component
      className={clsx(
        ...
        // link underline
        'transition-all duration-150 ease-in-out prose-a:no-underline prose-a:shadow-[inset_0_-2px_0_0_var(--tw-prose-background,#fff),inset_0_calc(-1*(var(--tw-prose-underline-size,4px)+1px))_0_0_var(--tw-prose-underline,theme(colors.sky.600))] hover:prose-a:[--tw-prose-underline-size:5px] dark:[--tw-prose-background:theme(colors.gray.900)] dark:prose-a:shadow-[inset_0_calc(-1*var(--tw-prose-underline-size,2px))_0_0_var(--tw-prose-underline,theme(colors.amber.300))] dark:hover:prose-a:[--tw-prose-underline-size:4px]',
        // pre
